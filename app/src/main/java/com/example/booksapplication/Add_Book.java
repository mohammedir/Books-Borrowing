        ...
        ADD_Book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(editText_namebook.getText().toString())||!TextUtils.isEmpty(editText_typebook.getText().toString())){
                    ...
                    Model_Book model_book2 = new Model_Book(editText_namebook.getText().toString() , editText_typebook.getText().toString(),editText_describe.getText().toString(),editText_communicate.getText().toString() , mAuth.getCurrentUser().getUid(),key);
